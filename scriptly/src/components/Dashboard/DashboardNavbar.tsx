...
import { Bell, Code2, Plus, Search, Settings, UserCircle2 } from "lucide-react";
      ...
      <div className="mx-auto flex h-16 items-center justify-between px-4 sm:px-6 max-w-7xl">
        ...
        <div className="flex items-center gap-6 sm:gap-10">
          <div className="flex items-center gap-3 cursor-pointer">
            ...
            <div>
              ...
              <p className="hidden sm:block text-xs text-slate-500">Collaborative Coding</p>
            </div>
          </div>
        ...
        <div className="flex items-center gap-3">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="hidden sm:flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-lg hover:shadow-violet-300">
            <Plus size={18} />
            New Project
          </motion.button>
